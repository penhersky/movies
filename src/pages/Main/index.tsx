...
import { MovieCard, Slick, SEO } from '../../components';
...
const text = `Space of new movies, ratings of the best films from professionals,statistics, descriptions of films and a lot of useful informationabout what to watch in the evening.`;
...
export default (props: { loading: boolean; error: boolean }) => {
  ...
  return (
    <>
      <SEO
        title='A site with the latest information about movies'
        description={text}
        keywords={[
          'Space Movies',
          'movies',
        ...
        <div className='main-body'>
          ...
          <div className='body-text'>
            <div id='main-text'>
              ...
              <Typography>
                3. All links to resources on the Web that contain videos and
                other intellectual property are posted for free by visitors of
                the resource for advertising or for informational purposes. Any
                information on the site is automatically posted without any
                control from any side, which corresponds to the generally
                accepted world practice of posting information on the Internet.
              </Typography>
              <Typography>
                ...
                resource are not the subject of financial relations between
                users and site owners.
              </Typography>
              <Typography>
                5. Using this resource, the user agrees that he is 18 years old
                and assumes the risks associated with the possible harm caused
                by the use of information in published materials.
              </Typography>
              <Typography>
